...
class JavythonVisitor(ParseTreeVisitor):
    ...
    # Visit a parse tree produced by JavythonParser#declVar.
    def visitDeclVar(self, ctx:JavythonParser.DeclVarContext):
        return self.visitChildren(ctx)


    # Visit a parse tree produced by JavythonParser#declConst.
    def visitDeclConst(self, ctx:JavythonParser.DeclConstContext):
        return self.visitChildren(ctx)
    ...
    # Visit a parse tree produced by JavythonParser#forInit.
    def visitForInit(self, ctx:JavythonParser.ForInitContext):
        return self.visitChildren(ctx)


    # Visit a parse tree produced by JavythonParser#forUpdate.
    def visitForUpdate(self, ctx:JavythonParser.ForUpdateContext):
        return self.visitChildren(ctx)


    # Visit a parse tree produced by JavythonParser#incDecUpdate.
    def visitIncDecUpdate(self, ctx:JavythonParser.IncDecUpdateContext):
        return self.visitChildren(ctx)
