...
class JavythonListener(ParseTreeListener):
    ...
    # Enter a parse tree produced by JavythonParser#declVar.
    def enterDeclVar(self, ctx:JavythonParser.DeclVarContext):
        pass

    # Exit a parse tree produced by JavythonParser#declVar.
    def exitDeclVar(self, ctx:JavythonParser.DeclVarContext):
        pass


    # Enter a parse tree produced by JavythonParser#declConst.
    def enterDeclConst(self, ctx:JavythonParser.DeclConstContext):
        pass

    # Exit a parse tree produced by JavythonParser#declConst.
    ...
    # Enter a parse tree produced by JavythonParser#forInit.
    def enterForInit(self, ctx:JavythonParser.ForInitContext):
        pass

    # Exit a parse tree produced by JavythonParser#forInit.
    def exitForInit(self, ctx:JavythonParser.ForInitContext):
        pass


    # Enter a parse tree produced by JavythonParser#forUpdate.
    def enterForUpdate(self, ctx:JavythonParser.ForUpdateContext):
        pass

    # Exit a parse tree produced by JavythonParser#forUpdate.
    def exitForUpdate(self, ctx:JavythonParser.ForUpdateContext):
        pass


    # Enter a parse tree produced by JavythonParser#incDecUpdate.
    def enterIncDecUpdate(self, ctx:JavythonParser.IncDecUpdateContext):
        pass

    # Exit a parse tree produced by JavythonParser#incDecUpdate.
    def exitIncDecUpdate(self, ctx:JavythonParser.IncDecUpdateContext):
        pass
